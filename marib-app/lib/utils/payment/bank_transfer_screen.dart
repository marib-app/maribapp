...
class _BankTransferScreenState extends State<BankTransferScreen>
  ...
  Future<void> _loadBanks() async {
    ...
    try {
      ...
      final bool wifiPlanFlow = wifiPlanIdParam != null;
      final List<String>? effectiveAllowedGateways = wifiPlanFlow
      ...
      if (effectiveAllowedGateways != null &&
        ...
        if (effectiveAllowedGateways.contains(_walletMethod)) {
          methodForSettings = _walletMethod;
        } else if (effectiveAllowedGateways.contains(_eastYemenMethod)) {
          methodForSettings = _eastYemenMethod;
        } else if (effectiveAllowedGateways.contains(_manualBankMethod)) {
