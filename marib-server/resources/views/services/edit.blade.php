        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3 paid-fields">
            ...
            <select id="currency" name="currency" class="form-select @error('currency') is-invalid @enderror">
              ...
              <option value="YER" {{ $curOld==='YER'?'selected':'' }}>{{ __('Yemeni Rial') }}</option>
              <option value="USD" {{ $curOld==='USD'?'selected':'' }}>{{ __('US Dollar') }}</option>
              <option value="SAR" {{ $curOld==='SAR'?'selected':'' }}>{{ __('Saudi Riyal') }}</option>
            </select>
            ...
            <div class="border rounded p-3 mb-3">
              <div class="row g-3">
                ...
                <div class="col-md-12" id="field-values-div" style="display:none;">
                  ...
                  <select id="cf_values" data-tags="true" data-token-separators="[',']" data-placeholder="{{__('Select an option')}}" data-allow-clear="true" class="select2 w-100 full-width-select2" multiple="multiple"></select>
                </div>
          ...
          <div id="cf_inputs_wrap" class="col-12 mb-3" style="display:none;">
            <div class="border rounded p-3">
              <h6 class="mb-3">{{ __('Custom Field Values') }}</h6>
          ...
          <div class="col-12">
            ...
            <a href="{{ route('services.index') }}" class="btn btn-light-secondary me-1 mb-1">{{ __('Cancel') }}</a>
          </div>
