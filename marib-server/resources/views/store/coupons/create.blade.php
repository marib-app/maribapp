...
@section('title', __('merchant_coupons.create_title'))
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('merchant.coupons.store') }}" method="POST">
                    @csrf
                    @include('store.coupons._form')

                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn btn-primary">{{ __('merchant_coupons.save_button') }}</button>
