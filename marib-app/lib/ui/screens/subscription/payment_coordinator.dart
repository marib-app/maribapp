...
class PaymentCoordinator {
  static Future<void> requestIntent(BuildContext context, PaymentRequest r) async {
      ...
      case PayGateway.paystack:
        Navigator.push(context, MaterialPageRoute(
          builder: (_) => PaymentWebView(
            authorizationUrl: intent["payment_gateway_response"]["data"]["authorization_url"],
            reference:        intent["payment_gateway_response"]["data"]["reference"],
            onSuccess: (_) async { await onServerApply(); onSuccessUI(); },
            onFailed:  (_) => HelperUtils.showSnackBarMessage(context, 'فشل الدفع'),
            onCancel:  () => HelperUtils.showSnackBarMessage(context, 'تم إلغاء الدفع'),
          ),
        ));
        break;
