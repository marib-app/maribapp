        ...
        <div class="card">
            <div class="card-body">
                <form id="createComputerForm"
                      action="{{ route('item.computer.products.store') }}"
                      method="POST"
                      enctype="multipart/form-data">

                    @csrf

                    <input type="hidden" name="interface_type" value="computer">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <a href="{{ route('item.computer.products') }}" class="btn btn-light-secondary me-1 mb-1">{{ __('Cancel') }}</a>
                        </div>
                    </div>
                </form>
            </div>
