...
// ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???? ?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·????
...
class BankTransferScreen extends StatefulWidget {
  ...
  /// ?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ¶ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?????? ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???????ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ©.
...
class _BankTransferScreenState extends State<BankTransferScreen>
  ...
  int? _selectedBankId;
  int?
      _pressedBankId; // ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ«?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ¶?ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ· (Scale)
  int?
      _highlightedAccountNameBankId; // ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ«?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ¶?ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ· ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ° ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·???????ط¢آ·?ط¢آ·????
  ...
  // ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬?
  final _senderCtrl =
      TextEditingController(); // ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬?
  final _transferCodeCtrl =
      TextEditingController(); // ?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ©
  final _notesCtrl =
      TextEditingController(); // ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·????
  bool _allowRoutePop =
      false; // ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ­ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?ط¢آ·???ط¢آ·
  ...
  bool _attempted =
      false; // ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ· ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?ط¢آ·???ط¢آ§ ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬آ ?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬?
  ...
  Future<void> _loadBanks() async {
    ...
    try {
      ...
      final settings = await _service.fetchManualPaymentSettings(
        ...
        wifiPlanId: widget.args.wifiPlanId ?? widget.args.itemId,
      );
  ...
  String _resolveBankDisplayName(BankAccount bank) {
    ...
    if (accountNumber != null && accountNumber.isNotEmpty) {
      return '?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ $accountNumber';
    }
    final String? iban = bank.iban?.trim();
    if (iban != null && iban.isNotEmpty) {
      return 'IBAN $iban';
    }
    return '?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·????';
  }
    ...
    try {
      ...
      if (bytes > 5 * 1024 * 1024) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text(
                  '?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آµ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???? 5MB')),
        );
        return;
      }
  ...
  Future<void> _submit({String? eastYemenCode}) async {
    ...
    if (_selectedMethod == null) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('الرجاء اختيار طريقة الدفع أولاً.')),
        );
      }
      return;
    }
    ...
    if (_usingManualBank && !_receiptOk && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('الرجاء إرفاق إيصال التحويل واختيار البنك قبل المتابعة.')),
      );
      return;
    }
    ...
    if (_usingWallet && walletPurpose) {
      _showOverlayMessage(
        'لا يمكن الدفع من المحفظة لغرض شحن المحفظة. يرجى اختيار بوابة أخرى.',
    ...
    if (_usingManualBank && !_manualGatewayAllowed) {
      _showOverlayMessage(
        'ط·ع¾ط¸â€¦ ط·ع¾ط·آ¹ط·آ·ط¸ظ¹ط¸â€‍ ط·آ·ط·آ±ط¸â€ڑ ط·آ§ط¸â€‍ط·ع¾ط·آ­ط¸ث†ط¸ظ¹ط¸â€‍ ط·آ§ط¸â€‍ط¸ظ¹ط·آ¯ط¸ث†ط¸ظ¹ط·آ© ط¸â€‍ط¸â€،ط·آ°ط·آ§ ط·آ§ط¸â€‍ط·آ·ط¸â€‍ط·آ¨.',
    ...
    try {
      ...
      if (!ensured || resolvedIntentId == null || resolvedIntentId.isEmpty) {
        _showOverlayMessage(
          'طھط¹ط°ط± طھظ‡ظٹط¦ط© ط·ظ„ط¨ ط§ظ„ط¯ظپط¹طŒ ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ظ„ط§ط­ظ‚ط§ظ‹ ط£ظˆ ط§ظ„طھط­ظ‚ظ‚ ظ…ظ† ط§ظ„ط§طھطµط§ظ„.',
          type: MessageType.error,
        );
        return;
      }
      ...
      final int? resolvedServiceId = normalizedPurpose == 'service'
          ? widget.args.serviceId ?? widget.args.itemId
          : widget.args.serviceId;
      ...
      if ((submissionCurrencyCandidate ?? '').isEmpty) {
        _showOverlayMessage(
          '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ©?ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·????. ?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ° ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?ط¢آ·???ط¢آ§.',
          type: MessageType.error,
        );
        return;
      }
      ...
      final String successMessage = (() {
        ...
        return _usingEastYemen
            ? '?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع© ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ­.'
            : _usingWallet
                ? '?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آµ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ­.'
                : '?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·????';
      })();
      ...
      final String errorMessage = (() {
        ...
        if (t.isNotEmpty) return t;
        return _usingEastYemen
            ? '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ©?ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©. ?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ°.'
            : _usingWallet
                ? '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ©?ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آµ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ©. ?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ°.'
                : '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ©?ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·????. ?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ°.';
      })();
      ...
      final String successMessageWithReference = displayReference != null
          ? '$successMessage\n?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ©: $displayReference'
          : successMessage;
      ...
      if (!mounted) return;
      _showOverlayMessage(
          '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ©?ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·????: $e',
          type: MessageType.error);
    } finally {
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ©',
                          style: TextStyle(
                            fontSize: 16,
                      ...
                      IconButton(
                        tooltip:
                            '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©',
                  ...
                  Text(
                    '?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ©: ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ©?ط¢آ·?ط¢آ·???أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·???????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ° ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©.',
                    style: TextStyle(
                      height: 1.5,
                  ...
                  ...[
                    '?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ­ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع© ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?????? ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ° ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢.',
                    '?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ¦?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ©?ط¢آ·?ط¢آ·???أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©.',
                    '?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ± "?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢".',
                    '?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?ط¢آ·?أ¢â‚¬â„¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آµ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·????.',
                    '?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ® ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???? ?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?? ?ط¢آ·???????ط¢آ·?????? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ·?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع© ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ©.',
                    '?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ¶?ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ· ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ° ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·????.',
                  ].map(
                    (step) => Padding(
                  ...
                  const SizedBox(height: 16),
                  Text(
                    '?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬??: ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ¬?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?ط¢آ·?أ¢â‚¬â„¢ ?ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ©?ط¢آ·?ط¢آ·???أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·?ط¢آ·???ط¢آµ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?ط¢آ·???ط¢آ­?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·???????ط¢آ·?????? ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?ط¢آ·???أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§ ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·???????ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ° ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?ط¢آ·?أ¢â‚¬â„¢ ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·???ط¢آ¦?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬??.',
                    style: TextStyle(
                      height: 1.5,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.of(sheetContext).pop(),
                      child: const Text(
                          '?ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·????'),
                    ),
                  ),
                ],
              );
  ...
  Future<void> _copyValueToClipboard(String value,
    ...
    HelperUtils.showSnackBarMessage(
      overlayContext,
      '?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ® $label',
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: Text(
            '?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·???????ط¢آ·?ط¢آ·???? ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع©',
            style: TextStyle(
              fontWeight: FontWeight.w700,
              color: onSurface,
            ),
          ...
          content: const Text(
              '?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬???ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬? ?ط¢آ·?ط¢آ·?????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?ط¢آ·???? ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?ط¢آ·???ط¢آ±?ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢ ?ط¢آ·???????ط¢آ·?????? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?ط¢آ·?أ¢â€ڑآ¬??ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â‚¬ع© ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???????ط¢آ·?ط¢آ·???ط¢آ°?ط¢آ·?ط¢آ·???ط¢آ© ?ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?أ¢â€ڑآ¬??ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???أ¢â‚¬ط›'),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(dialogContext).pop(false),
              child: const Text(
                  '?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ©'),
            ),
            FilledButton(
...
/* ========================= ?ط¢آ·?ط¢آ·?????ط¢آ·???????ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ¦?ط¢آ·?ط¢آ·???ط¢آ± ?ط¢آ·?ط¢آ·???ط¢آ®?ط¢آ·???????ط¢آ·???????ط¢آ·?????? ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·?????ط¢آ·???ط¢آ«?أ¢â€ڑآ¬ط¢آ ?ط¢آ·?????أ¢â‚¬ع‘ط¢آ¬?ط¢آ  ?ط¢آ·?ط¢آ·?????ط¢آ·?ط¢آ·???ط¢آ§?ط¢آ·???ط¢آ¦?أ¢â€ڑآ¬أ¢â€‍آ¢?ط¢آ·?ط¢آ·???ط¢آ¬ ========================= */
