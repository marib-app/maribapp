                        ...
                        <div class="card-body mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mandatory">
                                    ...
                                    <select name="department" id="department" class="form-control" required>
                                        @foreach($departments as $key => $label)
                                            <option value="{{ $key }}" {{ old('department', $tip->department ?? 'store') === $key ? 'selected' : '' }}>{{ __($label) }}</option>
                                        @endforeach
                                    </select>
                                    @error('department')
                                ...
                                <div class="col-md-12 form-group mandatory">
                                    ...
                                    <textarea name="description" id="description" class="form-control" cols="10" rows="5" required>{{ old('description', $tip->description) }}</textarea>
                                </div>
                            </div>
