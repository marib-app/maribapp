                        ...
                        <div class="card-body mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mandatory">
                                    ...
                                    @php
                                        ...
                                        if(empty($defaultDepartment)) {
                                            $defaultDepartment = (isset($departmentKeys) && in_array('store', $departmentKeys, true))
                                                ? 'store'
                                                : array_key_first($departments);
                                        }
                                    @endphp
                                    ...
                                    <select name="department" id="department" class="form-control" required>
                                        @foreach($departments as $key => $label)
                                            <option value="{{ $key }}" {{ $defaultDepartment === $key ? 'selected' : '' }}>{{ __($label) }}</option>
                                ...
                                <div class="col-md-12 form-group mandatory">
                                    ...
                                    <textarea name="description" id="description" class="form-control" cols="10" rows="5" required>{{ old('description') }}</textarea>
                                </div>
                            </div>
