                    ...
                    <div class="col-12">
                        ...
                        <table class="stable-borderless table-striped" aria-describedby="mydesc" id="table_list"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="is_customer_option" data-align="center" data-sortable="true" data-formatter="customerOptionFormatter">{{ __('خيار للزبون') }}</th>
...
@section('js')
    <script>
        function imageFormatter(value, row) {
            if (value) {
                return '<img src="' + value + '" class="img-thumbnail" width="50" height="50" />';
            }
            return '-';
        }

        function customerOptionFormatter(value, row) {
            if (value === 1 || value === true || value === '1' || value === 'true') {
                return '<span class="badge bg-success"><i class="bi bi-check-lg"></i> نعم</span>';
            } else {
                return '<span class="badge bg-secondary"><i class="bi bi-x-lg"></i> لا</span>';
            }
        }
    </script>
@endsection
