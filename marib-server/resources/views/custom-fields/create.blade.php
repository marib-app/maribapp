...
@section('script')
<script>
    // إظهار/إخفاء أقسام الإدخال بحسب نوع الحقل
    function applyTypeUI(selectedType) {
        const isOptionsType = ['checkbox', 'radio', 'dropdown'].includes(selectedType);
        const isLengthType  = ['number', 'textbox', 'color'].includes(selectedType);

        if (isOptionsType) {
            $('#field-values-div').slideDown(300);
        } else {
            $('#field-values-div').slideUp(300);
        }

        if (isLengthType) {
            $('.min-max-fields').slideDown(300);
        } else {
            $('.min-max-fields').slideUp(300);
        }
    }
    ...
    $(document).ready(function () {
        ...
        // تفعيل الحالة الابتدائية
        applyTypeUI($('#type').val());

        // دالة الاسترجاع بعد نجاح الإنشاء
        window.afterCustomFieldCreation = function () {
            setTimeout(function () {
...
<section class="section">
    <form action="{{ route('custom-fields.store') }}" method="POST"
          class="create-form" data-success-function="afterCustomFieldCreation"
                ...
                <div class="card">
                    ...
                    <div class="card-body mt-2">
                        <div class="row">
                            ...
                            <!-- Field Type (مع color لكن بلا color_values) -->
                            <div class="col-md-12 form-group mandatory">
                            ...
                            <!-- Field Values: للأنواع القائمة على خيارات فقط -->
                            ...
                            <!-- Min/Max Length: للـ number/textbox/color -->
                            <div class="col-md-6 form-group min-max-fields" style="display:none;">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mandatory">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input status-switch" type="checkbox" role="switch" aria-label="required">
                                    {{ __('Required') }}
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" role="switch" name="is_customer_option" id="is_customer_option" value="1">
