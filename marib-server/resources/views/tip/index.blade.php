...
@section('js')
    <script>
        function departmentFormatter(value, row) {
            const label = value ?? row.department ?? '';
            const key = row.department ?? '';

            return `<span data-department="${key}">${label}</span>`;
        }
    </script>
@endsection
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-striped" aria-describedby="mydesc"
                                ...
                                <tr>
                                    ...
                                    <th scope="col" data-field="department_label" data-align="center" data-sortable="true" data-formatter="departmentFormatter">{{ __('Department') }}</th>
