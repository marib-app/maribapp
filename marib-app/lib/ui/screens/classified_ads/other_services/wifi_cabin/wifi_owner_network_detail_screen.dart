...
class _WifiOwnerNetworkDetailScreenState
  ...
  Future<void> _confirmDeletePlan(WifiPlan plan) async {
    ...
    final bool? confirmed = await UiUtils.showBlurredDialoge(
      ...
      dialoge: BlurredRichDialog(
        ...
        body:
        'سيتم حذف الفئة وجميع الأكواد المرتبطة بها بشكل نهائي. تأكد من رغبتك في المتابعة.',
        actions: [
          BlurredAction(
            label: 'إلغاء',
            isPrimary: false,
  ...
  void _showToggleToast() {
    UiUtils.showSoftSnackBar(
      context,
      message: 'تعذر تنفيذ تفعيل/إيقاف الشبكة من التطبيق حالياً.',
    );
  }
  ...
  Future<void> _pickAndSetImage({required bool isLogo}) async {
    ...
    UiUtils.showSoftSnackBar(
      context,
      message: isLogo
          ? "تم تغيير شعار الشبكة مؤقتاً."
          : "تم تغيير صورة شاشة الدخول مؤقتاً.",
    );
  }
}
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'ابحث برقم الكرت أو اسم المشتري',
              ...
              Expanded(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(value: 'available', child: Text('المتاحة')),
                    DropdownMenuItem(value: 'sold', child: Text('المباعة')),
                  ],
          ...
          Wrap(
            ...
            runSpacing: 10,
            children: [
              _StatCard(label: 'إجمالي الأكواد', value: total),
...
class _PlanRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    isHeader ? 'المباعة' : soldValue.clamp(0, total).toString();
    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          subtitle: const Text('إدارة حالة ظهور الشبكة للمستخدمين'),
...
class _AddPlanSheetState extends State<_AddPlanSheet> {
  ...
  Future<void> _submit() async {
    ...
    if (price == null || duration == null) {
      UiUtils.showSoftSnackBar(
        context,
        message: 'يرجى إدخال سعر ومدة صالحة.',
      );
      return;
    }
          ...
          child: Column(
            ...
            children: [
              ...
              OutlinedButton.icon(
                ...
                label: Text(_voucherName ?? 'رفع ملف الأكواد (اختياري)'),
              ),
