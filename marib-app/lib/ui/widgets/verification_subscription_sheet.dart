...
class _VerificationSubscriptionSheetState
  ...
  Widget _buildError(BuildContext context, String message) {
    return Column(
      ...
      children: [
        ...
        Text(
          message.isNotEmpty ? message : 'ÍÏË ÎØÃ ÃËäÇÁ ÌáÈ ÇáÈíÇäÇÊ',
      ...
      children: [
        ...
        Text(
          message?.isNotEmpty == true
              ...
              : _local(
                  context,
                  ar: 'ï¿½ï¿½ ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½',
        ...
        Text(
          _local(
            context,
            ar: 'ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½',
  ...
  Widget _buildDetails(BuildContext context, VerificationRequestModel model) {
    ...
    final String statusText = expired
        ? _local(context, ar: 'ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', en: 'Expired')
    ...
    return Column(
      ...
      children: [
              ...
              child: Column(
                ...
                children: [
                  Text(
                    _local(
                      context,
                      ar: 'ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½',
                  ...
                  Text(
                    _local(
                      context,
                      ar: 'ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½',
        ...
        _InfoRow(
          ...
          label: _local(context, ar: 'ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', en: 'Activated on'),
          value:
              approvedAt != null ? dateFmt.format(approvedAt.toLocal()) : '-',
        ),
        _InfoRow(
          icon: Icons.event_busy_rounded,
          label: _local(context, ar: 'ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', en: 'Expires on'),
          value: expiresAt != null ? dateFmt.format(expiresAt.toLocal()) : '-',
          valueColor: expired ? context.color.error : null,
        ),
        _InfoRow(
          icon: Icons.schedule_rounded,
          label: _local(context, ar: 'ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', en: 'Time remaining'),
  ...
  String _remainingLabel(BuildContext context, DateTime? expiresAt) {
    if (expiresAt == null) {
      return _local(context, ar: 'ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½', en: 'Not available');
    }
    final Duration diff = expiresAt.difference(DateTime.now());
    if (diff.isNegative) {
      return _local(context, ar: 'ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', en: 'Expired');
    }
    ...
    if (days > 0) {
      parts.add(
          '$days ${_local(context, ar: days == 1 ? 'ï¿½ï¿½ï¿½' : 'ï¿½ï¿½ï¿½ï¿½', en: days == 1 ? 'day' : 'days')}');
    }
    if (hours > 0) {
      parts.add(
          '$hours ${_local(context, ar: hours == 1 ? 'ï¿½ï¿½ï¿½ï¿½' : 'ï¿½ï¿½ï¿½ï¿½ï¿½', en: hours == 1 ? 'hour' : 'hours')}');
    }
    if (parts.isEmpty) {
      parts.add(
          '$minutes ${_local(context, ar: 'ï¿½ï¿½ï¿½ï¿½ï¿½', en: minutes == 1 ? 'minute' : 'minutes')}');
    }
    return parts.join(' ');
  }
