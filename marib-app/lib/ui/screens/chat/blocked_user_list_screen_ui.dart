part of 'blocked_user_list_screen.dart';

extension _BlockedUserListScreenUi on _BlockedUserListScreenState {
  Widget buildBlockedUserListScreen(BuildContext context) {
    return Scaffold(
          ...
          if (state is BlockedUsersListSuccess) {
            if (state.data.isEmpty) {
              return NoDataFound(
                ...
                category: EmptyStateCategory.blocked,
              );
            }
            return Column(
              children: [
  ...
  Widget buildUserList(BuildContext context, BlockedUserModel user) {
    return BlocProvider(
