...
class TipController extends Controller {
    ...
    public function create() {
        ...
        return view('tip.create', compact('languages', 'departments', 'departmentKeys'));
    ...
    public function store(Request $request) {
        ...
        $request->validate([
            ...
            'department'     => ['required', Rule::in($departmentKeys)],
        ...
        try {
            DB::beginTransaction();
            $payload = $request->only(['description', 'department', 'translations']);
            $tip = Tip::create(Arr::except($payload, ['translations']));
    ...
    public function edit($id) {
        ...
        $departments = app(DepartmentReportService::class)->availableDepartments();
        $departmentKeys = array_keys($departments);
        return view('tip.edit', compact('tip', 'languages', 'translations', 'departments', 'departmentKeys'));
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $payload = $request->only(['description', 'department', 'translations']);
            $tip->update(Arr::except($payload, ['translations']));
