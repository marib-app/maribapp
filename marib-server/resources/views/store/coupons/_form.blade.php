...
<div class="row g-3">
    <div class="col-md-4">
        <label class="form-label" for="code">{{ __('merchant_coupons.code_label') }} <span class="text-danger">*</span></label>
    ...
    <div class="col-md-4">
        <label class="form-label" for="name">{{ __('merchant_coupons.name_label') }} <span class="text-danger">*</span></label>
    ...
    <div class="col-md-4">
        <label class="form-label" for="discount_type">{{ __('merchant_coupons.discount_type_label') }} <span class="text-danger">*</span></label>
        <select id="discount_type" name="discount_type" class="form-select" required>
            <option value="percentage" @selected(old('discount_type', $coupon->discount_type ?? '') === 'percentage')>{{ __('merchant_coupons.discount_type_percentage') }}</option>
            <option value="fixed" @selected(old('discount_type', $coupon->discount_type ?? '') === 'fixed')>{{ __('merchant_coupons.discount_type_fixed') }}</option>
        </select>
        @error('discount_type')
            <div class="text-danger small">{{ $message }}</div>
        @enderror
    ...
    <div class="col-md-4">
        <label class="form-label" for="discount_value">{{ __('merchant_coupons.discount_value_label') }} <span class="text-danger">*</span></label>
    ...
    <div class="col-md-4">
        <label class="form-label" for="minimum_order_amount">{{ __('merchant_coupons.minimum_order_label') }}</label>
    ...
    <div class="col-md-4">
        <label class="form-label" for="max_uses">{{ __('merchant_coupons.max_uses_label') }}</label>
    ...
    <div class="col-md-4">
        <label class="form-label" for="max_uses_per_user">{{ __('merchant_coupons.max_uses_per_user_label') }}</label>
    ...
    <div class="col-md-4">
        <label class="form-label" for="starts_at">{{ __('merchant_coupons.starts_at_label') }}</label>
    ...
    <div class="col-md-4">
        <label class="form-label" for="ends_at">{{ __('merchant_coupons.ends_at_label') }}</label>
    ...
    <div class="col-12">
        <label class="form-label" for="description">{{ __('merchant_coupons.description_label') }}</label>
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            ...
            <label class="form-check-label" for="is_active">{{ __('merchant_coupons.is_active_label') }}</label>
        </div>
        @error('is_active')
            <div class="text-danger small">{{ $message }}</div>
        @enderror
    ...
    <div class="col-12">
        <small class="text-muted d-block">{{ __('merchant_coupons.form_hint') }}</small>
    </div>
</div>
