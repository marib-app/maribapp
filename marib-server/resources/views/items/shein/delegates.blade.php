    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('item.shein.delegates') }}" class="row g-3 align-items-end mb-4">
                    ...
                    <div class="col-lg-3 col-md-2">
                        <a href="{{ route('item.shein.delegates') }}" class="btn btn-outline-secondary w-100">{{ __('إعادة تعيين') }}</a>
                    </div>
                </form>
