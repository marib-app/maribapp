        ...
        <div class="col-lg-3 col-12 card" id="auth-box">
            ...
            <div class="center mtop-75">
                <div class='login_heading'>
                    <h3>مرحبا بعودتك</h3>
                    <p>أدخل التفاصيل الخاصة بك لتسجيل الدخول إلى حسابك</p>
                </div>
                ...
                <div class="pt-4">
                    <form method="POST" action="{{ route('login') }}" id="frmLogin">
                        ...
                        <button class="btn btn-primary btn-block btn-sm shadow-lg mt-3 login_btn">تسجيل الدخول</button>
                        @if (config('app.demo_mode'))
                            <div class="text-danger text-center mt-2" role="alert">
                                إذا لم تتمكن من تسجيل الدخول، فانقر هنا.
