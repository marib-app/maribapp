...
<section class="section">
    ...
    <!-- إحصائيات طلبات الكمبيوتر -->
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-0 pb-0">
                    <h3 style="font-weight: 600">إحصائيات طلبات الكمبيوتر</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-4 col-md-12">
                                            <div class="svg_icon align-items-center d-flex justify-content-center me-3">
                                                <span class="fas fa-laptop text-white fa-2x"></span>
                                            </div>
                                        </div>
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-0 pb-0">
                    <h3 style="font-weight: 600">بحث في طلبات الكمبيوتر</h3>
                </div>
                <div class="card-body">
    ...
    <!-- جدول طلبات الكمبيوتر -->
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-0 pb-0">
                    <h3 style="font-weight: 600">قائمة طلبات الكمبيوتر</h3>
                </div>
                <div class="card-body">
