...
class AuthRepository {
  ...
  Future<Map<String, dynamic>> numberLoginWithApi(
    ...
    try {
      ...
      final String errorMessage = e.errorMessage?.toString() ?? '';

      final bool shouldRetryWithSignup =
          errorMessage.contains('404') || errorMessage.contains('409');

      if (!shouldRetryWithSignup) {
        rethrow;
      }
