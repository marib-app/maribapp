...
class Api {
  ...
  static void _ensureNetworkInterceptor(Dio dio) {
    ...
    final bool hasInterceptor = dio.interceptors
        .any((interceptor) => interceptor is NetworkRequestInterseptor);
  ...
  static String walletRecipientsApi = "wallet/recipients";
  static String walletRecipientLookupApi = "wallet/recipients/lookup";
  ...
  static String ownerWifiNetworkCodesApi(int id) =>
      "wifi/owner/networks/$id/codes";

  static String ownerWifiNetworkStatsApi(int id) =>
      "wifi/owner/networks/$id/stats";
