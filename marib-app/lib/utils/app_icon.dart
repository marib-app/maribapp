...
class AppIcons {
  ...
  static String profile = _svgPath("profile_active_sc");
  ...
  static String wallet = _svgPath("wallet");
  ...
  static String guide = _svgPath("guide");
  static String competition = _svgPath("competition");
  ...
  static String transaction = _svgPath("bottomnav/transaction");
  static String transactionActive = _svgPath("bottomnav/transaction_active");
  static String more = _svgPath("bottomnav/more");
  static String more_active = _svgPath("bottomnav/more_active");

  static String cart = _svgPath("Cart");
...
static String us = _svgPath("currency/usa");
  ...
  static String delivery = _svgPath("delivery");

  static String summary = _svgPath("summary");

  static String kilogram = _svgPath("kilogram_12");
