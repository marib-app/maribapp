...
class PaymentLabelService
{
...

    {
        ...
        $data = self::normalizePayload([
            ...
            'gateway_display' => $transaction->getOriginal('gateway_label') ?? null,
            'channel_label' => $transaction->getOriginal('channel_label') ?? null,
            'payment_gateway_label' => $transaction->getOriginal('payment_gateway_label') ?? null,
