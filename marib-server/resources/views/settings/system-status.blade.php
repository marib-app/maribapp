                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="#" data-bs-toggle="tooltip" title="{{ $isLinked ? _('Storage folder is currently linked.') : _('Storage folder is not linked. Click to link it.') }}">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <form action="{{ route('toggle.storage.link') }}" method="GET" class="m-0">
