...
class _BankTransferScreenState extends State<BankTransferScreen>
  ...
  final _transferCodeCtrl =
      TextEditingController(); // متحكم إدخال للنص
  ...
  Future<void> _loadBanks() async {
    ...
    try {
      ...
      // استخدم allowedGateways المعرّفة مرة واحدة أدناه
    ...
    try {
      ...
      if (bytes > 5 * 1024 * 1024) {
        ...
        UiUtils.showSoftSnackBar(
          context,
          message:
              'حجم الملف يتجاوز 5 ميغابايت، يرجى اختيار ملف أصغر.',
        );
      }
    ...
    if (_selectedMethod == null) {
      if (mounted) {
        UiUtils.showSoftSnackBar(
          context,
          message:
              'الرجاء اختيار طريقة الدفع أولًا.',
        );
      }
      return;
    }
