  ...
  Future<void> _confirmDeletePlan(WifiPlan plan) async {
    ...
    final bool? confirmed = await UiUtils.showBlurredDialoge(
      ...
      dialoge: BlurredRichDialog(
        title: 'Õ–› «·›∆… «·„Õœœ…ø',
        body:
        '”Ì „ Õ–› «·›∆… ÊÃ„Ì⁄ «·√ﬂÊ«œ «·„— »ÿ… »Â« »‘ﬂ· ‰Â«∆Ì.  √ﬂœ „‰ —€» ﬂ ›Ì «·„ «»⁄….',
        actions: [
          BlurredAction(
            label: '≈·€«¡',
            isPrimary: false,
        ...
        children: [
          Wrap(
            ...
            children: [
              ...
              _StatCard(label: '«·œ›⁄« ', value: stats['batches'] ?? 0),
              _StatCard(label: '≈Ã„«·Ì «·√ﬂÊ«œ', value: stats['total'] ?? 0),
              _StatCard(label: '«·„ «Õ…', value: stats['available'] ?? 0),
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(value: '', child: Text('«·ﬂ·')),
                    DropdownMenuItem(value: 'available', child: Text('«·„ «Õ…')),
          ...
          Wrap(
            ...
            runSpacing: 10,
            children: [
              _StatCard(label: '≈Ã„«·Ì «·√ﬂÊ«œ', value: total),
              _StatCard(label: '«·„ «Õ…', value: available),
      ...
      children: [
        ...
        ListTile(
          leading: Icon(Icons.power_settings_new_rounded,
              color: colors.territoryColor),
          title: const Text(' ›⁄Ì·/≈Ìﬁ«› «·‘»ﬂ…'),
          subtitle: const Text('≈œ«—… Õ«·… ŸÂÊ— «·‘»ﬂ… ··„” Œœ„Ì‰'),
          ...
          child: Column(
            ...
            children: [
              ...
              _TextField(
                ...
                label: '«”„ «·›∆…',
                validator: (value) =>
                value == null || value.trim().isEmpty ? 'Â–« «·Õﬁ· „ÿ·Ê»' : null,
              ),
              const SizedBox(height: 12),
              Row(
                children: [
              ...
              OutlinedButton.icon(
                ...
                label: Text(_voucherName ?? '—›⁄ „·› «·√ﬂÊ«œ («Œ Ì«—Ì)'),
              ),
